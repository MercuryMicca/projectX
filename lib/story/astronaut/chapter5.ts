...
export const astronautChapter5StoryNodes: Record<string, StoryNode> = {
  science_intro: {
    ...
    narration:
      "The station is running. Now the question becomes whether the work it makes possible will be careful enough to matter.",
    blockType: "narration",
    autoAdvanceTo: "science_start",
    choices: [],
  },
  ...
  science_start: {
    ...
    blockType: "open",
    openNextNodeId: "science_deviation",
    suggestedPrompts: [
      "Follow the procedure exactly",
      "Read the full sequence and plan the flow",
      "Check the most sensitive conditions first",
    ],
    choices: [],
  },
  ...
  science_wrap: {
    ...
    blockType: "open",
    openNextNodeId: "final_question",
    suggestedPrompts: [
      "Write today's debrief first",
      "Check remaining supplies and consumables",
      "Drift to the window for one quiet minute",
    ],
    choices: [],
  },
